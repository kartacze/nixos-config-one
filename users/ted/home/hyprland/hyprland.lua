...
local menu = 'rofi -show drun -show combi -icon-theme "gruvbox-light" -show-icons'
...
--
hl.window_rule({
	name = "Move Brave to Workspace 8",
	match = { class = "^brave$" },
	workspace = "8 silent",
})
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(browser), { window = "8 silent" })
...
-- Move active workspace to the next/right monitor
...
-- require("/home/ted/.config/hypr/ted.lua")
